...
This allows your project to be installed and editable (i.e. you can modify the source code and have changes when importing modules and running executables without need to reinstall)
